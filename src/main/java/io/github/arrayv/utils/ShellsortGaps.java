...
public class ShellsortGaps {
    public enum Sequence {
        ...
        FRANKLAZ {
            ...
            @Override
            public String getName() { return "Frank & Lazarus"; }
        },
        HIBBARD {
        ...
        INCERPI {
            ...
            public int[] getGaps(int n) { return gaps; }
            @Override
            public String getName() { return "Incerpi & Sedgewick"; }
        },
        SEDGE_82 {
        ...
        GBY {
            ...
            @Override
            public String getName() { return "Gonnet & Baeza-Yates"; }
        },
        TOKUDA {
        ...
        PRIMES_2 {
            ...
            public int[] getGaps(int n) { return gaps; }
            @Override
            public String getName() { return "Prime > 2 * Last Gap"; }
        },
        PRIMES_3 {
            ...
            public int[] getGaps(int n) { return gaps; }
            @Override
            public String getName() { return "Prime > 3 * Last Gap"; }
        },
        SEDG_82M {
    ...
    public static final Sequence DEFAULT = Sequence.MCH_1636;

    public static Sequence showSelectionDialog() {
        ...
        for (int i = 0; i < values.length; i++) {
            ...
            String suffix = values[i] == DEFAULT ? " <i>(default)</i>" : "";
            names[i] = "<html>" + name + suffix + "</html>";
        }

        JList<String> list = new JList<>(names);
        list.setSelectionMode(ListSelectionModel.SINGLE_SELECTION);

        JLabel label = new JLabel("Select Gap", SwingConstants.CENTER);
        label.setBorder(BorderFactory.createEmptyBorder(0, 0, 8, 0));
        JPanel panel = new JPanel(new java.awt.BorderLayout());
        panel.add(label, java.awt.BorderLayout.NORTH);
        panel.add(new JScrollPane(list), java.awt.BorderLayout.CENTER);

        String defaultLabel = "Use default";
        ...
        JDialog dialog = pane.createDialog(null, "Customize Sort");
    ...
    // Gap sequence {48, 21, 7, 3, 1} was once used for the cleanup pass in Quick Shellsort
}
