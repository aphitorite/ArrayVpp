...
final public class LogKitaSortAlt extends Sort {
    ...
    private int[] quickselect(int[] array, int[] tmp, int a, int b, int r) {
    	...
    	return new int[] {Math.min(a, m1 + 1), Math.max(b, m2)};
    }
    ...
    public void logkita(int[] array, int a, int b) {
    	...
    	// block merge
    	kita(array, aux, a, bnds[0], bnds[0], plg-1, array[bnds[0]], 0, true);
    	kita(array, aux, bnds[1], b, a, plg-1, array[bnds[1]-1], 1, false);
    }
