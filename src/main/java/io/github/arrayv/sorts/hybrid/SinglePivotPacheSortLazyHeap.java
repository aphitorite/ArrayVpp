...
final public class SinglePivotPacheSortLazyHeap extends Sort {
    public SinglePivotPacheSortLazyHeap(ArrayVisualizer arrayVisualizer) {
        super(arrayVisualizer);

        this.setSortListName("Single-Pivot Pache (Lazyheap)");
