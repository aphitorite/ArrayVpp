...
final public class SinglePivotPacheSortSBBLazyHeap extends Sort {
    public SinglePivotPacheSortSBBLazyHeap(ArrayVisualizer arrayVisualizer) {
        super(arrayVisualizer);

        this.setSortListName("Single-Pivot Pache (SBB Lazyheap)");
        this.setRunAllSortsName("Single-Pivot Pache Sort (Single Bit Buffer)");
        this.setRunSortName("Single-Pivot Pache Sort (SBB Lazyheap)");
