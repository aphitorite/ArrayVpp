...
public class WeavedIntrospectivePatternDefeatingIterativeHyperPopsort2 extends Sort {
	public WeavedIntrospectivePatternDefeatingIterativeHyperPopsort2(ArrayVisualizer arrayVisualizer) {
    ...
    public void runSort(int[] array, int currentLength, int bucketCount) {
    	this.pdiPop(array, 0, currentLength, 1, currentLength, 0);
    }
}